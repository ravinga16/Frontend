                ...
                <MDBCard style={{ width: "30rem" }}>
                    ...
                    <MDBCardBody>
                        ...
                        <form style={{ textAlign: "left",display:"block" ,fontSize:"13px"}} id="showProfile">
                            ...
                            <div class="row">
                            <div class="col-md-5"> <MDBBtn onClick={this.handleEditProfile}>Edit Profile</MDBBtn></div>
                            </div>
                        ...
                        <form onSubmit={this.handleUpdate} style={{ textAlign: "left",display:"none" ,fontSize:"13px"}} id="editProfile"> 
                            ...
                            <div class="col-md-5"> <MDBBtn type="submit" onClick={this.handleCancel}>Cancel</MDBBtn></div>
                            </div>
