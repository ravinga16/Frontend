...
class MyBooking extends React.Component{
    ...
    componentDidMount(){
        ...
        axios.get('http://localhost:3000/ordersClient/upcomingjobs/'+localStorage.getItem('UserId'),{withCredentials:true})
        .then(response => {
        ...
        axios.get('http://localhost:3000/ordersClient/completedorders/'+localStorage.getItem('UserId'),{withCredentials:true})
        .then(response => {        
            //get the response sent by the API. setState to the response data this.setState({posts:response.data})
        ...
        axios.get('http://localhost:3000/ordersClient/cancelledjobs/'+localStorage.getItem('UserId'),{withCredentials:true})
        .then(response => {        
            //get the response sent by the API. setState to the response data this.setState({posts:response.data})
        ...
        axios.get('http://localhost:3000/requests/owner/'+localStorage.getItem('UserId'),{withCredentials:true})
        .then(response => {        
            //get the response sent by the API. setState to the response data this.setState({posts:response.data})
